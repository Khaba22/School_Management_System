...
public class LActivities extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("Submissions");
    ...
    public void uploadOnClick(View view) {
        if (filePath != null) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(LActivities.this);
            progressDialog.setTitle("Uploading file");
            progressDialog.show();

            //getting the storage reference
            final StorageReference sRef = storageReference.child("Submissions/"+System.currentTimeMillis() + "." + getFileExtension(filePath));
