...
public class LProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l_profile);
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LProfile.this, MainActivity.class);
    ...
    public void goToProfileUpdate ( View view ) {
        Intent intent = new Intent(LProfile.this, UpdateLearnerProfile.class);
