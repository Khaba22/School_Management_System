...
public class ViewG5Submissions extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    listView.setOnItemLongClickListener(
        (parent, view, position, id) -> {
          ...
          AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ViewG5Submissions.this);
  ...
  private void retrieveSubmissionsFiles() {
    ...
    Query checkUser = dRef.orderByChild("grade").equalTo("5");
        ...
        new ValueEventListener() {
          ...
          public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            if (snapshot.exists()) {
              ...
              Toast.makeText(ViewG5Submissions.this, "NO SUBMISSIONS FOUND...", Toast.LENGTH_LONG)
                  .show();
              dialog.dismiss();
            }
          }
