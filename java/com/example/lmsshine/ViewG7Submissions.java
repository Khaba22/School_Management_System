...
public class ViewG7Submissions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener(
                (parent, view, position, id) -> {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ViewG7Submissions.this);
    ...
    private void retrieveSubmissionsFiles() {
        ...
        Query checkUser = dRef.orderByChild("grade").equalTo("7");
                ...
                new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()) {
                            ...
                            Toast.makeText(ViewG7Submissions.this, "NO SUBMISSIONS FOUND...", Toast.LENGTH_LONG)
                                    .show();
                            dialog.dismiss();
                        }
                    }
